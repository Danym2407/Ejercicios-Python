...
# Prueba del árbol con los valores de la imagen
arbol = ArbolBinario()
valores = [6, 4, 7, 2, 5, 9, 1, 3, 8]

for v in valores:
    arbol.insertar(v)

print("Recorrido inorden:")
arbol.inorden(arbol.raiz)  # Salida esperada: 1 2 3 4 5 6 7 8 9
print("\n")
...
print(f"Profundidad del árbol: {arbol.profundidad(arbol.raiz)}")  # Esperado: 4

print("Nodos hoja:", end=" ")
arbol.imprimir_hojas(arbol.raiz)  # Esperado: 1 3 5 8
print("\n")

print(f"Máximo valor en el árbol: {arbol.encontrar_maximo(arbol.raiz)}")  # Esperado: 9
